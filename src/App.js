...
const initialFlights = [
  { id: 1, number: 'Ab123', status: 'On Time', gate: 'A1' },
  { id: 2, number: 'Bb456', status: 'Delayed', gate: 'B2' },
  { id: 3, number: 'Cb789', status: 'Cancelled', gate: 'C3' },
  { id: 4, number: 'Db789', status: 'On Time', gate: 'D4' },
  { id: 5, number: 'Eb789', status: 'On Time', gate: 'B2' }
];
